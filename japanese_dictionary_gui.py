...
choose_language.place(x= 6, y =0)
enter_text = Label(root, text = "Enter your text here:")
enter_text.place(x = 6, y = 60 )
...
button3.place(x = 145, y =20 )
button4.place(x = 185, y = 20  )
button5.place(x = 106, y = 20)
button6.place(x= 560, y = 40)
dropdown.place(x=6, y= 20 , height= 40, width= 100 )
