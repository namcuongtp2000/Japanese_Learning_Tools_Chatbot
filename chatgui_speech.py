...
def activate_microphone_language():
    ...
    if smsg_en != '':
        ...
        if res =='open handwriting':
            ...
            playvoice('OK. Please make sure you entered text in text entry box before start using microphone. I will summarize your documents immediately, please wait for a second.')
            summary()
        else:
...
ChatLog.place(x=6,y=30, height=370, width=1345)
