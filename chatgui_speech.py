...
HandwritingButton = Button(base, font=("Verdana",7,'bold'), text="Open dictionary", width="16", height=5,
...
HandwritingButton.place(x = 6, y = 638,height=30)
base.mainloop()
