...
def activate_microphone_language():
    ...
    if smsg_en != '':
        ...
        if res =='open handwriting':
            ...
            os.system('python summarizing.py')
        else:
...
dropdown.place(x=4, y = 453,height=40, width=100 )
...
DictionaryButton = Button(base, font=("Verdana",7,'bold'), text="Open dictionary", width="16", height=5,
                    bd=0, bg="#ADFF2F", activebackground="#3c9d9b",fg='#ffffff',
...
EntryBox.place(x=136, y=420, height=340, width=1225)
SendButton.place(x=6, y=420, height=30,width=140)
#ActiveButton.place(x=6,y=456,height=30)
SummarizerButton.place(x=6,y=494,height=30,width= 140)
UploadSummarizeButton.place(x=6, y=530, height=30, width= 140 )
SearchGoogleButton.place(x= 6,y= 564, height= 30 ,width=140)
DictionaryButton.place(x = 6, y = 598,height=30,width= 140)
MicrophoneButton.place(x=100,y = 455)
base.mainloop()
